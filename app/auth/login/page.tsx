...
import { allowUnverifiedOwnerContact, appPath, basePath } from "@/lib/config";
...
function LoginContent() {
  ...
  const isPostLogin = normalizeNext(next).includes("/post");
  const preferGoogleFirst =
    isPostLogin && allowUnverifiedOwnerContact && !showPhoneOnly && !confirmation;
      ...
      <div className="rp-card w-full max-w-md p-6 sm:p-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-[var(--muted)]">
          {showPhoneOnly
            ...
            : isPostLogin && allowUnverifiedOwnerContact
              ? "Sign in with Google to start posting. You will enter your WhatsApp contact on the next screen — OTP is optional."
        ...
        {preferGoogleFirst && (
          <>
            ...
            <div className="my-6 flex items-center gap-3">
              ...
              <span className="text-xs text-[var(--muted)]">or use mobile OTP</span>
              <div className="h-px flex-1 bg-[var(--border)]" />
            </div>
          </>
        )}
        ...
        {!showPhoneOnly && !preferGoogleFirst && (
          <>
